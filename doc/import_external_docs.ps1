...
$external_docs = @{
    ...
    "uno.wasm.bootstrap" = @{ ref="d7e2344b13301cd4c3b0639dd51918329bdeee2d" } #latest main commit
    ...
    "uno.extensions" = @{ ref="fe41369918d0acef8aea76b28149586dd23f5817" } #latest main commit
